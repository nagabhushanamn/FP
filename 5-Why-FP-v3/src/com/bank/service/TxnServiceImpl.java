...
public class TxnServiceImpl implements TxnService {
	...
	public List<Txn> getTxns(double amount) {
		// declarative style coding with function ==> functional programmming
	...
	public List<Txn> getTxns(LocalDate date) {
		// way-2: declarative code with function
		Predicate<Txn> byDateCondition = t -> t.getDate().equals(date);
