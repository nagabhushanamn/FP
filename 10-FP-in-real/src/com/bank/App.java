...
public class App {
	...
	public static void main(String[] args) {
		...
		List<Txn> txns = Txn.randomlyGenerate(20000000); // data-in
	...
	private static double getTotal_5(List<Txn> txns) {
		return txns.stream().mapToDouble(txn -> txn.getAmount()).sum();
	}
...
class TxnAnountAccumualtor {
	...
	public void accept(Txn txn) {
		total += txn.getAmount(); // read + increment with new-txn-amount + write
	}
